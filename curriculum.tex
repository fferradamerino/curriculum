...
\begin{document}
	...
	Ingeniero Civil en Informática con experiencia en desarrollo backend, sistemas de bajo nivel y herramientas de software. He desarrollado APIs, simuladores de arquitectura de computadores y herramientas de ingeniería inversa, trabajando con Java, Spring Boot, PostgreSQL, Go y Python. \\
	...
	\noindent
	\textbf{Certificaciones}: Domina la IA con Gemini [Santander Academy, 2026]; Certificate for Claude Code in Action [Anthropic, 2026]; Certificación en Gestión Ágil de Proyectos [Servicio Civil de Chile, 2026]; Learn React [Codecademy, 2025]; Quantum Computing Made Simple [Udemy, 2025]
